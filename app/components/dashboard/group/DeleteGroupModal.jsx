...
const DeleteGroupModal = (
    { openModal, setopenModal, group , deleteFunction }
) => {
    return (
        <ModalTemplate outsideClose={true} openModal={openModal} setopenModal={setopenModal}>
            ...
            <div className="flex justify-between gap-4 mt-8">
                ...
                <div  onClick={deleteFunction} className="bg-danger border border-danger w-full py-2 rounded-md text-center text-white">Ya</div>
            </div>
        </ModalTemplate>
    )
}
